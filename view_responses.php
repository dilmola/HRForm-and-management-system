                        ...
                        <!-- Content part-->
                                    <div class="content">
                                        <div class="container-fluid">
                                            ...
                                            <div class="card-1">
                                                <h2 class="mb-4 border-bottom">View Responses</h1>
                                                                ...
                                                                <div class="stat-widget-two card-body">
                                                                    ...
                                                                    <table id="forms-tbl" class="table table-stripped">
                                                                        ...
                                                                        <tbody>
                                                                            <?php 
                                                                            $i = 1;
                                                                                $forms = $db->conn->query("SELECT response_list.id, response_list.form_code, response_list.date_created, user.username, form_list.title
                                                                                FROM response_list 
                                                                                INNER JOIN form_list ON form_list.form_code=response_list.form_code 
                                                                                INNER JOIN user ON response_list.user_id=user.id WHERE response_list.form_code = '$formcode'");
